...
use Atournayre\Bundle\EntitiesEventsBundle\Command\GenerateListenersCommand;
...
return static function (ContainerConfigurator $container) {
    ...
    $services
        ...
        ->set(GenerateListenersCommand::class)->public()
            ->arg(0, param('kernel.project_dir'))
            ->arg(1, GenerateListenersCommand::NAME)
            ->tag('console.command')
    ;
};
